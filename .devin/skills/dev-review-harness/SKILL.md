...
2. Dispatch a `subagent_general` subagent, instruct it to read `agents/roles/nextjs-developer/role.md`, and pass the spec. **Run it in the foreground.** Never use `subagent_explore`.
